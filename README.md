...
The only file provided on this repository is `index.html`, and this is because our first task was to create a basic portfolio website to publish our assignments. If you go to the file, you will be directed to the website where you can see the individual assignments and final project.